...
/**
 * Servlet implementation class JDBC18DeleteSevlet
 */
@WebServlet("/JDBC18DeleteSevlet")
public class JDBC18DeleteSevlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JDBC18DeleteSevlet() {
        super();
